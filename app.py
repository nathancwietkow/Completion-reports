...
ADDITIONAL_PRODUCTS = {
    "jotamastic_90": {"name": "JOTAMASTIC 90", "reason": "to use with JOTUN HARDTOP XP"},
    "jotun_hardtop": {"name": "JOTUN HARDTOP XP", "reason": "which is a long-lasting topcoat that provides UV and weather resistant protection"}
}
